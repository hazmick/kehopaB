       ...
       <body style="background-color: #fafafa">
          <div style="max-width: 520px;margin: 32px auto;padding: 16px;line-height: 24px;">
            <div class="imgH">
             ...
             <div style="padding: 8px 0">
                <p>Welcome to Hazmick! We are delighted to have you here and look forward to helping you achieve your financial goals.</p>
             </div>
             <div style="padding: 8px 0">
          ...
          <div style="max-width: 600px; margin: 32px auto; padding: 16px; text-align: center;">
              <a
                ...
                href="https://hazmick.xyz/auth/activate/${token}"
                target="_blank"
        ...
        const emailData = {
          ...
          <html lang="en">
             <head>
                ...
                <meta http-equiv="X-UA-Compatible" content="IE=edge" />
                <meta name="viewport" content="width=device-width, initial-scale=1.0" />
                <title>Welcome to Hamzick</title>
                <style>
                   @import url("https://fonts.googleapis.com/css2?family=Lato:ital,wght@0,200;0,300;0,400;0,500;0,600;0,700;0,800;0,900;1,200;1,300;1,400;1,600;1,700;1,800;1,900&display=swap");html,body {font-family: "Lato";box-sizing: border-box;margin: 0;padding: 0;}.imgH {width: auto;padding: 16px 0;}p {margin: 0;font-size: 0.9em;}li {font-size: 0.8em;line-height: 1.8em;}
                </style>
             </head>
             <body style="background-color: #fafafa">
                <div style="max-width: 520px;margin: 32px auto;padding: 16px;line-height: 24px;">
                  <div class="imgH">
                   ...
                   <div style="padding: 8px 0">
                      <p>Thanks for signing up for Hazmick!</p>
                   </div>
                   <div style="padding: 8px 0">
                      <p>We're excited to have you get started. First, you need to know Hazmick will never ask you for your password or credentials, For more information about us, Kindly check our white paper and also subscribe to our YouTube channel for more useful videos about Hazmick.
                        Hazmick is the future of Cryptocurrency trading.</p>
                   </div>
                   <div style="padding: 24px 0 8px;">
                      <p style="font-weight: 700;">Signed</p>
                   <div style="padding: 4px 0">
                      <p>The Harari Group</p>
                   </div>
                   </div>
                </div>
                                    ...
                                    <tr>
                                      ...
                                      >
                                        <a
                                          ...
                                          href="https://hazmick.xyz/auth/resetpassword/${resetToken}"
                                          target="_blank"
                                          style="
                                            font-weight: bold;
                                            letter-spacing: normal;
                                ...
                                <tbody>
                                  <tr>
                                    ...
                                    >
                                      <div style="text-align: left">
                                        Regards,<br />
                                        <a href="https://hazmick.xyz" target="_blank"
                                          >hazmick.xyz</a
                                        >
                                      </div>
                                    </td>
       ...
       <body style="background-color: #fafafa">
          <div style="max-width: 520px;margin: 32px auto;padding: 16px;line-height: 24px;">
            <div class="imgH">
             ...
             <div style="padding: 8px 0">
                <p>You've successfully withdrawn ${amount}.00 USD from your account</p>
             </div>
             <div style="padding: 8px 0">
